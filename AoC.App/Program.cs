		...
		static void Main(string[] args)
		{
			...
			new AdventOfCode(2022)
				.Run(new IPuzzle[]
				{
					...
					new Year2022.Day19.NotEnoughMinerals()          { Answer = new string[] { "1466", "8250" } },
					...
					new Year2022.Day25.FullOfHotAir()               { Answer = new string[] { "121=2=1==0=10=2-20=2", "*" } },
				});
#endif
			...
			new AdventOfCode(2021)
				.Run(new IPuzzle[]
				{
					...
					new Year2021.Day22.ReactorReboot()              { Answer = new string[] { "591365", null } },
